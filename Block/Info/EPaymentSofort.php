...
class EPaymentSofort extends Info
{
    /**
     * Define template
     * 
     * @var string
     */
    protected $_template = 'Bluem_Integration::info/epayment-sofort.phtml';
    ...
    {
        $this->setTemplate('Bluem_Integration::info/pdf/epayment-sofort.phtml');
        return $this->toHtml();
    }
